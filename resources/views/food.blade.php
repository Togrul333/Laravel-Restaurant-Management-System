        ...
        <div class="col-lg-12">
            <div class="owl-menu-item owl-carousel">
                ...
                @foreach($data as $date)
                    <form action="{{url('/addcart',$date->id)}}" method="post">
                        @csrf
                        <div class="item">
                            <div style="background-image:url('/foodimage/{{$date->image}}');" class='card '>
                                <div class="price"><h6>{{$date->price}}$</h6></div>
                                <div class='info'>
                                    <h1 class='title'>{{$date->title}}</h1>
